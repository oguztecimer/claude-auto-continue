...
must_haves:
  ...
  key_links:
    - from: "npm registry"
      ...
      pattern: "github.com/oguztecimer/claude-auto-continue"
    - from: "npm install -g"
...
Run: `npm view claude-auto-continue` — must show correct author, description, repository
  ...
  <done>
`claude-auto-continue@1.0.0` is live on the npm registry with correct metadata (author: dakmor, repository: github.com/oguztecimer/claude-auto-continue, version: 1.0.0).
  </done>
</task>
